...
]{VHDLCodes/clockTick.vhd}

\lstinputlisting[
caption    = {Mod-$m$ counter},
language = Vhdl,
label      = {verilog:modMCounter}
]{VHDLCodes/modMCounter.vhd}
...
\begin{enumerate}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[scale=0.5]{newClockSource1}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[scale=0.5]{newClockSource2}
		\caption{Change `clkPulse' as `Clock Output'}
		\label{fig:newClockSource2}
	\end{figure}
	\begin{figure}[!h]
		\centering
		\includegraphics[scale=0.5]{newClockSource3}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[scale=0.5]{newClockSource4}
